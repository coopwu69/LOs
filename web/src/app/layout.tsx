  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col bg-page text-primary">
        <a href="#main-content" className="fixed left-4 top-4 z-[1000] -translate-y-24 rounded-lg bg-action px-4 py-2 text-sm font-medium text-inverse transition-transform focus-visible:translate-y-0 print:hidden">
